 ...
 *
 *    runner.download(path, { product: 'firefox' }, function(err) {
 *      // do amazing things!
 *    });
 *
 * Options (these are passed to fx-get-url):
...
function download(path, options, callback) {
  ...
  function saveToTemp(err, url) {
    ...
    console.log('Will download from url', url);
